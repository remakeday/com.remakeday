...
# 디렉터 확인 완료 2026-09-18 — 손목띠 번호는 그대로 유지(사용자 결정, docs/HANDOFF-26-09-18.md 8번).
    ...
    bundle = ScenarioBundleDTO(
        ...
        characters=[
            ...
            CharacterDTO(
                ...
                knowledge=[
                    ...
                    # 준은 손목띠에 관심이 많아 곁에 자주 있는 은상 번호도 안다 — 뜻은 모른다.
                    # 디렉터 확인 완료 2026-09-18 — 손목띠 번호 그대로 유지 결정(docs/HANDOFF-26-09-18.md 8번)과 같은 값이라 문제 없음.
        ...
        scene_actions=[
            ...
            SceneActionDTO(beat=5, actor="민석", action="방송실에 간다", witnesses=["은상"],
                ...
                # 테스터9 F14 — "문 앞까지"만 적으면 "방송실에 갔어?"에 안 갔다고 답했다.
                # 디렉터 확인 완료 2026-09-18 — 오전 커밋 cf5a0b7로 수정 반영, F14 사례1(기억과 반대되는 부정) 해소 확인됨.
        ...
        # 디렉터 확인 완료 2026-09-18 — 3·4단계 정답 근접 유지로 결정(docs/HANDOFF-26-09-18.md 7번), god-question-improvements로 반영(테스터9 F19).
        advisor_ladder=[
        ...
        # 상호 "○○"는 쓰지 않는다(2026-09-17 확정). 대본은 디렉터 확인 완료 2026-09-18 —
        # v9.0 §4.5에 동일 문구("축산 차량이 출발합니다. 문이 닫힐 때까지 자리에서 움직이지 마십시오.")로 확정(테스터9 F24).
        day_end_broadcasts=[
